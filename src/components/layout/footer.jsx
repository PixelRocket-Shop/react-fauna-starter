  ...
  footerLinks = [
    {
      ...
      links: [
        ...
        { label: 'How it works', href: getRouteByName('about') },
        { label: 'Pricing', href: getRouteByName('pricing') }
      ]
    },
    {
      title: 'Resources',
      links: [
        { label: 'Blog', href: getRouteByName('blog') },
        { label: 'Help Center', href: '#' },
        { label: 'Support', href: getRouteByName('contact') }
      ]
    },
    {
      title: 'Company',
      links: [
        { label: 'About', href: getRouteByName('about') },
        { label: 'Our Mission', href: getRouteByName('about') },
        { label: 'Careers', href: '#' },
        { label: 'Contact', href: getRouteByName('contact') }
      ]
    }
  ],
  newsletter = {
